...
const otherUsed = computed(() => Math.max(props.server.mem_used - props.server.arc_bytes, 0))
...
<template>
  <div class="drawer__section">
    ...
    <div class="drawer__kv"><span>Other used</span><span>{{ formatBytes(otherUsed) }}</span></div>
